<h1 align="center"> <img src="{{ site_url }}/site_assets/{{ page.title.lower() }}/logo.png" alt="logo" width="30" height="30"> {{ page.title }}</h1>

Custom [{{ page.title }}](https://github.com/causefx/Organizr) CSS

<p align="center">Dark Theme </p>

![]({{ site_url }}/site_assets/{{ page.title.lower() }}/dark.png)
