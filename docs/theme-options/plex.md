...
<p align="center">
    ...
    <a href="/theme-options/screenshots/unraid_{{ page.title.lower() }}.png" rel="noopener"><img src="/theme-options/screenshots/unraid_{{ page.title.lower() }}.png" alt="Screen Shot 4" width="49.15%" /></a>
