...
<p align="center">
    ...
    <a href="/community-themes/screenshots/prowlarr_{{ page.title.lower() }}.png" rel="noopener"><img src="/community-themes/screenshots/prowlarr_{{ page.title.lower() }}_small.png" alt="Screen Shot 3" width="49.15%" /></a>
    ...
    <a href="/community-themes/screenshots/unraid_{{ page.title.lower() }}.png" rel="noopener"><img src="/community-themes/screenshots/unraid_{{ page.title.lower() }}_small.png" alt="Screen Shot 4" width="49.15%" /></a>
